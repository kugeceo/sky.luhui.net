...
*/
 ...
 var mapTypes = {};
    ...
    mapTypes['sky'] = {
      ...
      name: 'Sky',
      credit: 'Image Credit: SDSS, DSS Consortium, NASA/ESA/STScI | Link to <a target="_blank" style="color:#000; text-decoration:underline;" href="https://creativecommons.org/licenses/">Creative Commons Licenses</a>'
    };
    /*
    var maxZoomIndex = 9
    ...
    */
    ...
    function initialize() {
      ...
      var mapOptions = {
        zoom: 6,
        center: new google.maps.LatLng(-68.6926,458.5969),
      ...
      var bounds = new google.maps.LatLngBounds(
            new google.maps.LatLng(1.80,29),
            new google.maps.LatLng(1.90,29.155));
      var srcImage = 'overlays/cosmos-redshift-7-cr7-galaxy-cc-by-4-ESOM-Kornmesser.jpg';
